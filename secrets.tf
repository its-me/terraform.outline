...
locals {
  database_url = "postgres://${var.postgresql_user}:${module.postgresql.database_password}@${module.postgresql.instance_private_ip}:${module.postgresql.port}/${var.postgresql_name}"
